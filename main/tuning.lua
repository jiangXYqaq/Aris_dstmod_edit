...
--感觉初始电量属于多余值，默认为0就行
-- ===== 电池 =====
TUNING.ALICE_BATTERY_MAX_USES = 1000          -- 电池最大容量
TUNING.ALICE_BATTERY_INITIAL_USES = 1000      -- 初始电量

-- ===== 遥控器 =====
TUNING.ALICE_REMOTE_MAX_FUEL = 100            -- 遥控器最大能量
TUNING.ALICE_REMOTE_INITIAL_FUEL = 100        -- 初始能量
TUNING.ALICE_REMOTE_RECHARGE_AMOUNT = 10      -- 每次充电恢复量
--扫地机器人
