...
TUNING.ALICE_BROOM_PICKUP_RADIUS = 15
...
TUNING.ALICE_LASERTHROW_PLANAR_DAMAGE_MIN = 50
TUNING.ALICE_LASERTHROW_PLANAR_DAMAGE_UP = 50
--此处多有改动，懒得备注了
...
TUNING.ALICE_SHOT2_RADIUS = 2
TUNING.ALICE_SHOT2_SPLASH_RADIUS = 5
