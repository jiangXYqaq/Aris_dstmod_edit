...
TUNING.ALICE_LIGHTSWORD_MODE4_PLANAR_DAMAGE_BASE = math.floor(GetModConfigData("lightsword_damage") * 0.5 + 0.5)
TUNING.ALICE_LIGHTSWORD_MODE4_PLANAR_DAMAGE_PER_LEVEL = math.floor(GetModConfigData("lightsword_damage") * 0.75 + 0.5)
--此处多有改动，懒得备注了
