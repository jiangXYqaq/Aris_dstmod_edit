...
TUNING.ALICE_LIGHTSWORD_DAMAGE_RATE = GetModConfigData("lightsword_damage") or 1
...
TUNING.ALICE_LIGHTSWORD_MODE4_PLANAR_DAMAGE_BASE = math.floor(TUNING.ALICE_LIGHTSWORD_DAMAGE_RATE * 3.4)
TUNING.ALICE_LIGHTSWORD_MODE4_PLANAR_DAMAGE_PER_LEVEL = math.floor(TUNING.ALICE_LIGHTSWORD_DAMAGE_RATE * 5.1)
--此处多有改动，懒得备注了
