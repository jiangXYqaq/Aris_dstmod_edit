...
TUNING.ALICE_LIGHTSWORD_MODE4_PLANAR_DAMAGE_BASE = math.floor(TUNING.ALICE_LIGHTSWORD_DAMAGE_RATE * 5.1)
TUNING.ALICE_LIGHTSWORD_MODE4_PLANAR_DAMAGE_PER_LEVEL = math.floor(TUNING.ALICE_LIGHTSWORD_DAMAGE_RATE * 6.8)
--此处多有改动，懒得备注了
...
TUNING.ALICE_BASIC_CHANCE = 0.3
TUNING.ALICE_BASIC_VALUE = 2.5
