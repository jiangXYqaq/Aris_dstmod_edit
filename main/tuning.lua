...
TUNING.MAGIC_HEALTH_REGEN = 60
TUNING.MAGIC_SANITY_REGEN = 120
--护盾回复
TUNING.MAGIC_SHIELD_REGEN = 30
--满血时护盾恢复值
TUNING.MAGIC_FULLHEALTH_SHIELD_REGEN = 90
TUNING.MAGIC_REGEN_INTERVAL = 30
...
-- ===== 光之剑各模式每次射击消耗的电池电量 =====
TUNING.ALICE_LIGHTSWORD_USE_MODE1 = 5      -- 连射模式
TUNING.ALICE_LIGHTSWORD_USE_MODE2 = 10      -- 能量炮弹
TUNING.ALICE_LIGHTSWORD_USE_MODE3 = 25      -- EX技能
TUNING.ALICE_LIGHTSWORD_USE_MODE4 = 3    -- 高能激光刀刃

--充电模块数据
TUNING.ALICE_CHARGE_INTERVAL = 15          -- 充电间隔（秒）
